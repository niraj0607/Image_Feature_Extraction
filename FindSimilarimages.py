from phase1_mongodb import loadDataset
...
feature_descriptors.insert(0, feature_descriptors.pop())
...
for i in range(n):
  ...
  if feature_descriptors[i].get("color_moments") and len(feature_descriptors[image_id])>3:
  ...
  if feature_descriptors[i].get("avgpool") and len(feature_descriptors[image_id])>3:
    ...
    # avgpool_pearson_correlation.append({"_id": feature_descriptors[i]["_id"],  "similarity": math.dist(feature_descriptors[image_id]["avgpool"], feature_descriptors[i]["avgpool"])})

  if feature_descriptors[i].get("layer3") and len(feature_descriptors[image_id])>3:
    ...
    # layer3_pearson_correlation.append({"_id": feature_descriptors[i]["_id"],  "similarity": math.dist(feature_descriptors[image_id]["layer3"], feature_descriptors[i]["layer3"])})

  if feature_descriptors[i].get("fc") and len(feature_descriptors[image_id])>3:
    ...
    # pearson_correlation.append({"_id": feature_descriptors[i]["_id"],  "similarity": math.dist(feature_descriptors[image_id]["fc"], feature_descriptors[i]["fc"])})
